...
(function(){
    ...
    function Curva() {
        ...
        this.update = function(u) {
            ...
            // var modulo=Math.sqrt(_der[0]*_der[0]+_der[1]*_der[1]+_der[2]*_der[2]);
            // _tangente[0] = _der[0]/modulo;
            // _tangente[1] = _der[1]/modulo;
            // _tangente[2] = _der[2]/modulo;1
            ...
            _binormal = vec3.cross(_binormal, _tangente, _normal);

        }

        // setear curva.set(_tipo, _puntosDeControl)
        //        curva.update(u)
        ...
        this.getTramos = function() { return _tramos; }
    }
