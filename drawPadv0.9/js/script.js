...
var margin   = { top: 50, right: 0, bottom: 0, left: 0},
	...
	modeSel  = 0,			// index modo/forma seleccionada
	startPos = [0, 0], 		// coordenada inicial de dibujo
	endPos   = [0, 0];		// coordenadas final de dibujo
...
function mouseStart() {
	...
	console.log("START mouse at "+ startPos);
	startDrawing();
}

function touchStart() {
	startPos = d3.touches(this)[0];
	d3.event.stopPropagation();
	console.log("START touch at "+ startPos);
	startDrawing();
}
